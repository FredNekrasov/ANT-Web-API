...
public class CatalogInteractor(IRepository<Catalog, int> repository) : IInteractor<Catalog, int>
{
    private readonly IRepository<Catalog, int> _repository = repository;
